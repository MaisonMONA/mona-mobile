    ...
    <ion-content :fullscreen="true">
      <div class="discoveryPhotoContainer">
        <div class="photoContainer">
          <ion-img
            id="defaultPhoto"
            :src="require('@/assets/drawable/mona_logo_med.png')"
          ></ion-img>
...
export default {
  ...
  data() {
    ...
    if (this.discovery.dType === "artwork") {
      ...
      if (this.discovery.getAccessibilities("fr"))
        accessibilities =
          "Accessibilité : " + this.discovery.getAccessibilities("fr");
      ...
      if (userData.filename) {
        Filesystem.readFile({
          ...
          const base64Result = await fetch(
            `data:image/${userData.filename.split(".").at(-1)};base64,${
              image.data
            }`
          );
